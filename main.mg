...
// C  is the list of elements representing the conjugacy classes, one per power orbit
// Cmax is the is the reduced list of conjugacy classes: one per orbit
...
DataFormat := recformat< G, C, Cred, M, H2, CMH2, H2Marked >;
