intrinsic AlgebraicResidueMap(G :: Grp, gis :: SeqEnum, His :: SeqEnum) -> GrpAb, Map
{Given
- a group G
...
intrinsic GeometricResidueMap(G :: Grp, CM :: ModCoho, H2 :: ModTupRng, gis :: SeqEnum, His :: SeqEnum) -> GrpAb, Map
{Given
- a group G
